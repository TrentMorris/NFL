...
object StatisticalMethodsSpec extends Specification {
	...
	"getTeamStats for 2013 " should {
		"return right first and last teams in DB for week 1" >> {
    		val t1Stats = StatisticMethods.getTeamStats("Baltimore Ravens", 1,"2013", statsList)
    		...
    		val t2Stats = StatisticMethods.getTeamStats("Washington Redskins", 1, "2013",statsList)
		...
		"return right first and last teams in DB for week 3" >> {
    		...
    		val t2Stats = StatisticMethods.getTeamStats("Oakland Raiders", 3, "2013",statsList)
		...
		"return right first and last teams in DB for week 4" >> {
    		val t1Stats = StatisticMethods.getTeamStats("San Francisco 49ers", 4, "2013",statsList)
    		...
    		val t2Stats = StatisticMethods.getTeamStats("New Orleans Saints", 4, "2013",statsList)
		...
		"return right first and last teams in DB for week 5" >> {
    		val t1Stats = StatisticMethods.getTeamStats("Buffalo Bills", 5, "2013",statsList)
    		...
    		val t2Stats = StatisticMethods.getTeamStats("New York Jets", 5, "2013",statsList)
		...
		"return right first and last teams in DB for week 6" >> {
    		val t1Stats = StatisticMethods.getTeamStats("Chicago Bears", 6, "2013",statsList)
    		...
    		val t2Stats = StatisticMethods.getTeamStats("San Diego Chargers", 6, "2013",statsList)
		...
		"return right first and last teams in DB for week 7" >> {
    		val t1Stats = StatisticMethods.getTeamStats("Arizona Cardinals", 7, "2013",statsList)
    		...
    		val t2Stats = StatisticMethods.getTeamStats("New York Giants", 7, "2013",statsList)
		...
		"return right first and last teams in DB for week 8" >> {
    		val t1Stats = StatisticMethods.getTeamStats("Carolina Panthers", 8, "2013",statsList)
    		...
    		val t2Stats = StatisticMethods.getTeamStats("St Louis Rams", 8,"2013", statsList)
		...
		"return right first and last teams in DB for week 9" >> {
    		val t1Stats = StatisticMethods.getTeamStats("Cincinnati Bengals", 9, "2013",statsList)
    		...
    		val t2Stats = StatisticMethods.getTeamStats("Green Bay Packers", 9, "2013",statsList)
		...
		"return right first and last teams in DB for week 10" >> {
    		val t1Stats = StatisticMethods.getTeamStats("Minnesota Vikings", 10, "2013",statsList)
    		...
    		val t2Stats = StatisticMethods.getTeamStats("Tampa Bay Buccaneers", 10, "2013",statsList)
		...
		"return right first and last teams in DB for week 11" >> {
    		val t1Stats = StatisticMethods.getTeamStats("Indianapolis Colts", 11,"2013", statsList)
    		...
    		val t2Stats = StatisticMethods.getTeamStats("New England Patriots", 11, "2013",statsList)
		...
		"return right first and last teams in DB for week 12" >> {
    		val t1Stats = StatisticMethods.getTeamStats("Atlanta Falcons", 12, "2013",statsList)
    		...
    		val t2Stats = StatisticMethods.getTeamStats("Washington Redskins", 12, "2013",statsList)
		...
		"return right first and last teams in DB for week 13" >> {
    		val t1Stats = StatisticMethods.getTeamStats("Baltimore Ravens", 13, "2013",statsList)
    		...
    		val t2Stats = StatisticMethods.getTeamStats("Seattle Seahawks", 13, "2013",statsList)
		...
		"return right first and last teams in DB for week 14" >> {
    		val t1Stats = StatisticMethods.getTeamStats("Houston Texans", 14, "2013",statsList)
    		...
    		val t2Stats = StatisticMethods.getTeamStats("Dallas Cowboys", 14, "2013",statsList)
		...
		"return right first and last teams in DB for week 15" >> {
    		val t1Stats = StatisticMethods.getTeamStats("Denver Broncos", 15, "2013",statsList)
    		...
    		val t2Stats = StatisticMethods.getTeamStats("Detroit Lions", 15, "2013",statsList)
		...
		"return right first and last teams in DB for week 16" >> {
    		val t1Stats = StatisticMethods.getTeamStats("Arizona Cardinals", 16, "2013",statsList)
    		...
    		val t2Stats = StatisticMethods.getTeamStats("San Francisco 49ers", 16, "2013",statsList)
		...
		"return right first and last teams in DB for week 17" >> {
    		val t1Stats = StatisticMethods.getTeamStats("Arizona Cardinals", 17, "2013",statsList)
    		...
    		val t2Stats = StatisticMethods.getTeamStats("Washington Redskins", 17, "2013",statsList)
		...
		"return empty list when not a real team name" >> {
			StatisticMethods.getTeamStats("FakeTeam", 17, "2013",statsList) === List()
		}
		"return empty list if not a real week" >> {
			StatisticMethods.getTeamStats("Pittsburgh Steelers", 18,"2013", statsList) === List()
		}
	}
    ...
    "getTeamStats for 2014" should {
        "return right first and last teams in DB for week 1" >> {
            val t1Stats = StatisticMethods.getTeamStats("Green Bay Packers", 1,"2014", stats2014)
            ...
            val t2Stats = StatisticMethods.getTeamStats("San Diego Chargers", 1, "2014",stats2014)
        ...
        // "return right first and last teams in DB for week 2" >> {
        //     val t1Stats = StatisticMethods.getTeamStats("New England Patriots", 2, "2014",stats2014)
        //     t1Stats === List()
        //     val t2Stats = StatisticMethods.getTeamStats("Pittsburgh Steelers", 2, "2014",stats2014)
        //     t2Stats = List()
        // }   
        // "return right first and last teams in DB for week 3" >> {
        //     val t1Stats = StatisticMethods.getTeamStats("Kansas City Chiefs", 3,"2014", stats2014)
        //     t1Stats === List()
        //     val t2Stats = StatisticMethods.getTeamStats("Oakland Raiders", 3, "2014",stats2014)
        //     t2Stats === List()
        // }
        // "return right first and last teams in DB for week 4" >> {
        //     val t1Stats = StatisticMethods.getTeamStats("San Francisco 49ers", 4, "2014",stats2014)
        //     t1Stats === List()
        //     val t2Stats = StatisticMethods.getTeamStats("New Orleans Saints", 4, "2014",stats2014)
        //     t2Stats === List()
        // }
        // "return right first and last teams in DB for week 5" >> {
        //     val t1Stats = StatisticMethods.getTeamStats("Buffalo Bills", 5, "2014",stats2014)
        //     t1Stats === List("10/03/2014", "Buffalo Bills", "24", "20", "31%", "31", "155", "40", "19", "188", "1", "0", "4", "21", "56", "27:37", "45.5", "Cleveland Browns", "37", "19", "41%", "32", "91", "28", "15", "199", "0", "0", "5", "23", "66", "32:23", "V", "-4", "41")
        //     val t2Stats = StatisticMethods.getTeamStats("New York Jets", 5, "2014",stats2014)
        //     t2Stats=== List("10/07/2014", "New York Jets", "30", "15", "55%", "22", "118", "20", "16", "170", "0", "0", "4", "29", "24", "24:34", "46.7", "Atlanta Falcons", "28", "26", "50%", "22", "64", "46", "37", "299", "0", "1", "2", "12", "46", "35:26", "V", "-10.5", "45")
        // }
        // "return right first and last teams in DB for week 6" >> {
        //     val t1Stats = StatisticMethods.getTeamStats("Chicago Bears", 6, "2014",stats2014)
        ...
        //     val t2Stats = StatisticMethods.getTeamStats("San Diego Chargers", 6, "2014",stats2014)
        ...
        // }
        // "return right first and last teams in DB for week 7" >> {
        //     val t1Stats = StatisticMethods.getTeamStats("Arizona Cardinals", 7, "2014",stats2014)
        ...
        //     val t2Stats = StatisticMethods.getTeamStats("New York Giants", 7, "2014",stats2014)
        ...
        // }
        // "return right first and last teams in DB for week 8" >> {
        //     val t1Stats = StatisticMethods.getTeamStats("Carolina Panthers", 8, "2014",stats2014)
        ...
        //     val t2Stats = StatisticMethods.getTeamStats("St Louis Rams", 8,"2014", stats2014)
        ...
        // }
        // "return right first and last teams in DB for week 9" >> {
        //     val t1Stats = StatisticMethods.getTeamStats("Cincinnati Bengals", 9, "2014",stats2014)
        ...
        //     val t2Stats = StatisticMethods.getTeamStats("Green Bay Packers", 9, "2014",stats2014)
        ...
        // }
        // "return right first and last teams in DB for week 10" >> {
        //     val t1Stats = StatisticMethods.getTeamStats("Minnesota Vikings", 10, "2014",stats2014)
        ...
        //     val t2Stats = StatisticMethods.getTeamStats("Tampa Bay Buccaneers", 10, "2014",stats2014)
        ...
        // }
        // "return right first and last teams in DB for week 11" >> {
        //     val t1Stats = StatisticMethods.getTeamStats("Indianapolis Colts", 11,"2014", stats2014)
        ...
        //     val t2Stats = StatisticMethods.getTeamStats("New England Patriots", 11, "2014",stats2014)
        ...
        // }
        // "return right first and last teams in DB for week 12" >> {
        //     val t1Stats = StatisticMethods.getTeamStats("Atlanta Falcons", 12, "2014",stats2014)
        ...
        //     val t2Stats = StatisticMethods.getTeamStats("Washington Redskins", 12, "2014",stats2014)
        ...
        // }
        // "return right first and last teams in DB for week 13" >> {
        //     val t1Stats = StatisticMethods.getTeamStats("Baltimore Ravens", 13, "2014",stats2014)
        ...
        //     val t2Stats = StatisticMethods.getTeamStats("Seattle Seahawks", 13, "2014",stats2014)
        ...
        // }
        // "return right first and last teams in DB for week 14" >> {
        //     val t1Stats = StatisticMethods.getTeamStats("Houston Texans", 14, "2014",stats2014)
        ...
        //     val t2Stats = StatisticMethods.getTeamStats("Dallas Cowboys", 14, "2014",stats2014)
        ...
        // }
        // "return right first and last teams in DB for week 15" >> {
        //     val t1Stats = StatisticMethods.getTeamStats("Denver Broncos", 15, "2014",stats2014)
        ...
        //     val t2Stats = StatisticMethods.getTeamStats("Detroit Lions", 15, "2014",stats2014)
        ...
        // }
        // "return right first and last teams in DB for week 16" >> {
        //     val t1Stats = StatisticMethods.getTeamStats("Arizona Cardinals", 16, "2014",stats2014)
        ...
        //     val t2Stats = StatisticMethods.getTeamStats("San Francisco 49ers", 16, "2014",stats2014)
        ...
        // }
        // "return right first and last teams in DB for week 17" >> {
        //     val t1Stats = StatisticMethods.getTeamStats("Arizona Cardinals", 17, "2014",stats2014)
        ...
        //     val t2Stats = StatisticMethods.getTeamStats("Washington Redskins", 17, "2014",stats2014)
        ...
        // }
        "return empty list when not a real team name" >> {
            StatisticMethods.getTeamStats("FakeTeam", 17, "2014",stats2014) === List()
        }
        "return empty list if not a real week" >> {
            StatisticMethods.getTeamStats("Pittsburgh Steelers", 18,"2014", stats2014) === List()
        }
    }
