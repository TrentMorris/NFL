...
object StatisticalMethodsSpec extends Specification with WinnerCalculator {
    ...
    "getTeamStats for 2013 " should {
        "return right first and last teams in DB for week 1" >> {
            val t1Stats = getTeamStats("Baltimore Ravens", 1,"2013")
            ...
            val t2Stats = getTeamStats("Washington Redskins", 1, "2013")
        ...
        "return right first and last teams in DB for week 2" >> {
            val t1Stats = getTeamStats("New England Patriots", 2, "2013")
            ...
            val t2Stats = getTeamStats("Pittsburgh Steelers", 2, "2013")
        ...
        "return right first and last teams in DB for week 3" >> {
            val t1Stats = getTeamStats("Kansas City Chiefs", 3,"2013")
            ...
            val t2Stats = getTeamStats("Oakland Raiders", 3, "2013")
        ...
        "return right first and last teams in DB for week 4" >> {
            val t1Stats = getTeamStats("San Francisco 49ers", 4, "2013")
            ...
            val t2Stats = getTeamStats("New Orleans Saints", 4, "2013")
        ...
        "return right first and last teams in DB for week 5" >> {
            val t1Stats = getTeamStats("Buffalo Bills", 5, "2013")
            ...
            val t2Stats = getTeamStats("New York Jets", 5, "2013")
        ...
        "return right first and last teams in DB for week 6" >> {
            val t1Stats = getTeamStats("Chicago Bears", 6, "2013")
            ...
            val t2Stats = getTeamStats("San Diego Chargers", 6, "2013")
        ...
        "return right first and last teams in DB for week 7" >> {
            val t1Stats = getTeamStats("Arizona Cardinals", 7, "2013")
            ...
            val t2Stats = getTeamStats("New York Giants", 7, "2013")
        ...
        "return right first and last teams in DB for week 8" >> {
            val t1Stats = getTeamStats("Carolina Panthers", 8, "2013")
            ...
            val t2Stats = getTeamStats("St Louis Rams", 8,"2013")
        ...
        "return right first and last teams in DB for week 9" >> {
            val t1Stats = getTeamStats("Cincinnati Bengals", 9, "2013")
            ...
            val t2Stats = getTeamStats("Green Bay Packers", 9, "2013")
        ...
        "return right first and last teams in DB for week 10" >> {
            val t1Stats = getTeamStats("Minnesota Vikings", 10, "2013")
            ...
            val t2Stats = getTeamStats("Tampa Bay Buccaneers", 10, "2013")
        ...
        "return right first and last teams in DB for week 11" >> {
            val t1Stats = getTeamStats("Indianapolis Colts", 11,"2013")
            ...
            val t2Stats = getTeamStats("New England Patriots", 11, "2013")
        ...
        "return right first and last teams in DB for week 12" >> {
            val t1Stats = getTeamStats("Atlanta Falcons", 12, "2013")
            ...
            val t2Stats = getTeamStats("Washington Redskins", 12, "2013")
        ...
        "return right first and last teams in DB for week 13" >> {
            val t1Stats = getTeamStats("Baltimore Ravens", 13, "2013")
            ...
            val t2Stats = getTeamStats("Seattle Seahawks", 13, "2013")
        ...
        "return right first and last teams in DB for week 14" >> {
            val t1Stats = getTeamStats("Houston Texans", 14, "2013")
            ...
            val t2Stats = getTeamStats("Dallas Cowboys", 14, "2013")
        ...
        "return right first and last teams in DB for week 15" >> {
            val t1Stats = getTeamStats("Denver Broncos", 15, "2013")
            ...
            val t2Stats = getTeamStats("Detroit Lions", 15, "2013")
        ...
        "return right first and last teams in DB for week 16" >> {
            val t1Stats = getTeamStats("Arizona Cardinals", 16, "2013")
            ...
            val t2Stats = getTeamStats("San Francisco 49ers", 16, "2013")
        ...
        "return right first and last teams in DB for week 17" >> {
            val t1Stats = getTeamStats("Arizona Cardinals", 17, "2013")
            ...
            val t2Stats = getTeamStats("Washington Redskins", 17, "2013")
        ...
        "return empty list when not a real team name" >> {
            getTeamStats("FakeTeam", 17, "2013") === List()
        }
        "return empty list if not a real week" >> {
            getTeamStats("Pittsburgh Steelers", 18,"2013") === List()
        }
    }
    
    "getTeamStats for 2014" should {
        "return right first and last teams in DB for week 1" >> {
            val t1Stats = getTeamStats("Green Bay Packers", 1,"2014")
            ...
            val t2Stats = getTeamStats("San Diego Chargers", 1, "2014")
        ...
        // }
        "return empty list when not a real team name" >> {
            getTeamStats("FakeTeam", 17, "2014") === List()
        }
        "return empty list if not a real week" >> {
            getTeamStats("Pittsburgh Steelers", 18,"2014") === List()
        }
    }

    "lastNGames2013" should {
        "return right number of games" >> {
            val games = lastNGames2013("Pittsburgh Steelers", 8, 7).distinct
            games must not contain List()
            games.size === 7
        }
        "not contain an empty List" >> {
            val games = lastNGames2013("Atlanta Falcons", 17, 16).distinct
            games must not contain List()
            games.size === 16
        }
    }
    "modifyStats" should {
        "not modify stats that matter" >> {
            ...
            val gameMod = modifyStats(game, Chromosome.basicChromosome())
            val testList = List(0.0, 0.0, 27.0, 24.0, 36.0, 21.0, 58.0, 62.0, 34.0 ,335.0 ,2.0 ,0.0 ,4.0,27.0,53.0,33.0 ,0.0, 0.0, 49.0, 24.0, 53.0, 23.0, 65.0, 42.0, 27.0, 445.0 ,0.0,2.0, 3.0, 17.0 ,61.0 ,26.0, 0.0, 0.0, 0.0)
            gameMod === testList
    ...
    "calculateTotalTeamScore" should {
        "return correct score" >> {
            val game = lastNGames2013("Baltimore Ravens", 1,1).flatten
            val gameMod = List(modifyStats(game, Chromosome.basicChromosome()))
            val score = calculateTotalTeamScore(gameMod)
            score === 1553.0
        }
        "be zero if chromosome is all zeroes" >>{
            val game = lastNGames2013("Baltimore Ravens", 1,1).flatten
            val gameMod = List(modifyStats(game, Chromosome.allZeroChromosome()))
    ...
    "calculateWinner" should {
        "return correct winner" >> {
            val winner = calculateWinner("Pittsburgh Steelers", "Cleveland Browns", Chromosome.basicChromosome, 6,3,"2013" )
            winner === "Cleveland Browns"
        }
        "return t1 if a tie" >> {
            val winner = calculateWinner("Pittsburgh Steelers", "Cleveland Browns", Chromosome.allZeroChromosome, 6,3,"2013" )
