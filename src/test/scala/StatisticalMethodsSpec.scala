...
object StatisticalMethodsSpec extends Specification with WinnerCalculator {
    ...
    "modifyStats" should {
        "not modify stats that matter" >> {
            ...
            val testList = List(0.0, 0.0, 27.0, 24.0, 36.0, 21.0, 58.0, 62.0, 34.0 ,335.0 ,2.0 ,0.0 ,4.0,27.0,53.0,33.0 ,50.7, 0.0, 49.0, 24.0, 53.0, 23.0, 65.0, 42.0, 27.0, 445.0 ,0.0,2.0, 3.0, 17.0 ,61.0 ,26.0, 0.0, -7.5, 49.5)
            gameMod === testList
    ...
    "calculateWinner" should {
        "return correct winner" >> {
            val winner = calculateWinner("Pittsburgh Steelers", "Cleveland Browns", new Chromosome(List.fill(35)(1.0.toFloat)), 6,3,"2013" )
